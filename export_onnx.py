...
def main(args):
    ...
    model.eval()
    torch.onnx.export(model, torch.randn(1, 3, 224, 224).to(device), 'convnext_base_22k_1k_224.onnx', export_params=True, input_names=['input'], output_names=['output'], dynamic_axes={"input": {0: "batch_size"}, "output": {0: "batch_size"}})
    exit()
